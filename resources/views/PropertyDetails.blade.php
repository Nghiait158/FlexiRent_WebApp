            ...
            <div class="infomation">
                <div class="bedAndBath">
                    <div>
                        ...
                        {{ $propertyDetail->nbedrooms ?: 'N/A'}} bedroom
                    </div>
                    ...
                    <div>
                        ...
                        {{ $propertyDetail->nbathrooms ?: 'N/A'}} bath
                    </div>

                </div>
                <div class="TienIch">
                    {{ $propertyDetail-> area ?: 'N/A'}} sq.ft | {{ strlen($propertyDetail->view) > 10 ? substr($propertyDetail->view, 0, 10) . '...' : ($propertyDetail->view ?: 'N/A') }}
                    view | {{ $propertyDetail-> floor ?: 'N/A'}} floor | @if ($propertyDetail->elevator == 1)
                    Elevator
                    @else
                    No elevator
                    @endif
