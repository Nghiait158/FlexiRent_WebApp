            ...
            <div class="input-container">
                <form method="POST" action="{{ route('property.store.amenities') }}">
                    ...
                    <div class="input-form">
                        ...
                        <div class="amenities">
                            <div class="form-check form-switch">
                                <input class="form-check-input custom-switch" name="TV" type="checkbox" role="switch" id="flexSwitchCheckDefault1"  value="1">
                                <label for="">TV</label>
                            </div>

                            <div class="form-check form-switch">
                                <input class="form-check-input custom-switch" name="Coffee_machine" type="checkbox" role="switch" id="flexSwitchCheckDefault1" value="1">
                                <label for="">Coffee machine</label>
                            </div>

                            <div class="form-check form-switch">
                                <input class="form-check-input custom-switch" name="Dryer" type="checkbox" role="switch" id="flexSwitchCheckDefault1" value="1">
                                <label for="">Dryer</label>
                            </div>

                            <div class="form-check form-switch">
                                <input class="form-check-input custom-switch" name="Phone" type="checkbox" role="switch" id="flexSwitchCheckDefault1" value="1">
                    ...
                    <div class="input-form">
                        ...
                        <div class="amenities">
                            <div class="form-check form-switch">
                                <input class="form-check-input custom-switch" name="Dish" type="checkbox" role="switch" id="flexSwitchCheckDefault1" value="1">
                                <label for="">Dish</label>
                            </div>

                            <div class="form-check form-switch">
                                <input class="form-check-input custom-switch" name="Fridge" type="checkbox" role="switch" id="flexSwitchCheckDefault1" value="1">
                                <label for="">Fridge</label>
                            </div>

                            <div class="form-check form-switch">
                                <input class="form-check-input custom-switch" name="Kettle" type="checkbox" role="switch" id="flexSwitchCheckDefault1" value="1">
                    ...
                    <div class="input-form">
                        ...
                        <div class="amenities">
                            <div class="form-check form-switch">
                                <input class="form-check-input custom-switch" name="Wardrobe" type="checkbox" role="switch" id="flexSwitchCheckDefault1" value="1">
                    ...
                    <div class="input-form">
                        ...
                        <div class="amenities">
                            <div class="form-check form-switch">
                                <input class="form-check-input custom-switch" name="Iron" type="checkbox" role="switch" id="flexSwitchCheckDefault1" value="1">
                                <label for="">Iron</label>
                            </div>

                            <div class="form-check form-switch">
                                <input class="form-check-input custom-switch" name="Work_desk" type="checkbox" role="switch" id="flexSwitchCheckDefault1" value="1">
                    ...
                    <div class="input-form">
                        ...
                        <div class="amenities">
                            <div class="form-check form-switch">
                                <input class="form-check-input custom-switch" name="Washing_Machine" type="checkbox" role="switch" id="flexSwitchCheckDefault1" value="1">
                                <label for="">Washing Machine</label>
                            </div>

                            <div class="form-check form-switch">
                                <input class="form-check-input custom-switch" name="Fireplace" type="checkbox" role="switch" id="flexSwitchCheckDefault1" value="1">
