            ...
            <div id="sidebar" class="nav-collapse">
                ...
                <div class="leftside-navigation">
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                ...
                                {{-- <li><a href="{{URL::to('/add_admin')}}">Add Admin</a>
                        </li> --}}
                    </ul>
                    </li>
                    <li class="sub-menu">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a href="{{URL::to('/manage_property')}}">Manage Property</a></li>
                            <li><a href="{{URL::to('/addProperty')}}">Add Property</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a href="{{URL::to('/manage_contract')}}">Manage Contracts</a></li>
                            <li><a href="{{URL::to('/addContract')}}">Add contract</a></li>
                        </ul>
                    </li>
