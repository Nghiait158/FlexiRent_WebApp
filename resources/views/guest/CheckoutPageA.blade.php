...
<div class="page-container">
                ...
                <div class="moves">
                    <div class="from move">
                        ...
                        <div class="pick-date">
                            ...
                            {{-- <p id="display-from" name="from">{{ $from }}</p> --}}
                            <input
                                type="date"
                                d="display-from"
                                name="from"
    ...
    gap: 8px;">
            ...
            <div class="payment-timeline">
                ...
                <div class="steps">
                    <div class="timeline">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="13" height="245" viewBox="0 0 13 245" fill="none">
                            <line x1="6.5" y1="4" x2="6.5" y2="300" stroke="#181A18" />
                            <circle cx="6.5" cy="6.5" r="6.5" fill="#181A18" />
                            <circle cx="6.5" cy="238.5" r="6.5" fill="#181A18" />
                        </svg>
        ...
        <script>
            ...
            document.getElementById("Reserve").value = `${dueNow.toFixed(2)}$`;
            ...
            function prepareReserveValue() {
                const reserveInput = document.getElementById("Reserve");
                // Lấy giá trị không bao gồm ký hiệu `$`
                const numericValue = reserveInput.value.replace('$', '');
                // Gán giá trị numeric vào thuộc tính name để gửi
